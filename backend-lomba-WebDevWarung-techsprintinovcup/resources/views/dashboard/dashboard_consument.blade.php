...
const token = localStorage.getItem("token"); // taruh di atas sekali
        ...
        result.data.forEach(product => {
            ...
            card.innerHTML = `
                ...
                <div class="card-right">
                    ...
                    <button class="btn-cart" onclick="addToCart(${product.id})">Tambah</button>
                </div>
            `;
    ...
    try{
        const response = await fetch(API_CART, {
            ...
            headers:{
                ...
                'Authorization': `Bearer ${token}`  // ✅ token terkirim
            },
